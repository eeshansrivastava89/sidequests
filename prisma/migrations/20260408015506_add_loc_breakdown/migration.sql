...
INSERT INTO "new_Derived" ("ahead", "behind", "branchName", "derivedJson", "dirtyFileCount", "framework", "healthScoreAuto", "hygieneScoreAuto", "id", "isDirty", "lastCommitDate", "locEstimate", "momentumScoreAuto", "projectId", "scoreBreakdownJson", "statusAuto") SELECT "ahead", "behind", "branchName", "derivedJson", "dirtyFileCount", "framework", "healthScoreAuto", "hygieneScoreAuto", "id", "isDirty", "lastCommitDate", "locEstimate", "momentumScoreAuto", "projectId", "scoreBreakdownJson", "statusAuto" FROM "Derived";
DROP TABLE "Derived";
